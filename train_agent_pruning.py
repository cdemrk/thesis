...
def train_drl_orchestrator(dataset_path, episodes=1500, w_cost=0.5, w_idle=0.5, top_k=10, save_name="model.pth"):
    print(f"=== Έναρξη Εκπαίδευσης DRL Agent με το {dataset_path} ===")
    print(f"Παράμετροι: Top-K={top_k} | W_Cost={w_cost}, W_Idle={w_idle} | Αποθήκευση: {save_name}")
    ...
    for episode in range(1, episodes + 1):
        ...
        for step, (w_id, current_workload) in enumerate(workload_items):
            ...
            # Ορίζουμε state & is_last_step ΣΤΗΝ ΑΡΧΗ
    ...
    # 5. Δυναμική αποθήκευση με βάση το save_name
...
if __name__ == "__main__":
    ...
    trained_agent = train_drl_orchestrator(
        ...
        w_idle=0.5, 
        top_k=8, 
        save_name="weights_pruning_top8.pth"
    )